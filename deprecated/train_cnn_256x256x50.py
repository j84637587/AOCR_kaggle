...
from dataset_torch import build_dataloader
from progressmeter import ProgressMeter, AverageMeter

from models.CNN3D import CNN3D
from models.EfficeientNet3d import EfficeientNet3d
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = EfficeientNet3d(num_classes=50, dropout_rate=0.1)
    ...
    root_directory = "data/preprocess/232x176x50_v2/1_Train,Valid_Image"
...
def train(train_loader, model, criterion, optimizer, epoch, logger, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        # logger.info(images.shape, target.shape)
